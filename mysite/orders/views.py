...
from mysite.settings import RAZORPAY_API_KEY_ID, RAZORPAY_API_KEY_SECRET
import razorpay
import json
...
def payments(request):
    ...
    for item in cart_items:
        ...
        orderproduct.ordered = True # By this time payment is successfull
        orderproduct.save()
...
def place_order(request, total=0, quantity=0):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            current_date = d.strftime('%Y%m%d')  #2022/10/19
